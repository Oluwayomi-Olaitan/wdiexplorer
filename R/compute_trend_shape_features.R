...
#' Defaults to `NULL`
#' @param verbose Logical, if TRUE, the message about the data download is printed. If FALSE, it is silenced.
#'
...
compute_trend_shape_features <- function(wdi_data, index = NULL, verbose = TRUE){
  ...
  if(any(is.na(valid_data[[index]]))) {
    ...
    if(verbose){
      message("Note: The dataset '",deparse(substitute(wdi_data)),
